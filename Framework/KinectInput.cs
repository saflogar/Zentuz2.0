...
namespace Beginning.Kinect.Framework.Input
{
    ...
    public static class KinectInput
    {
        ...
        #region WaveGesture
              ...
              public static readonly RoutedEvent WaveGestureEvent = EventManager.RegisterRoutedEvent("WaveGestureEvent", RoutingStrategy.Bubble,
            typeof(KinectCursorEventHandler), typeof(KinectInput));
        /// <summary>
        /// Adds a specified event handler for the KinectCursorMove event.
        /// </summary>
        /// <param name="o">The object that listens to the event.</param>
        /// <param name="handler">The event handler to add.</param>
        public static void AddWaveGestureHandler(DependencyObject o, KinectCursorEventHandler handler)
        {
            ((UIElement)o).AddHandler(WaveGestureEvent, handler);
        }
        /// <summary>
        /// Remove the specified event handler for the KinectCursorMove event.
        /// </summary>
        /// <param name="o">The object that listens to the event.</param>
        /// <param name="handler">The event handler to add.</param>
        public static void RemoveWaveGestureHandler(DependencyObject o, KinectCursorEventHandler handler)
        {
            ((UIElement)o).RemoveHandler(WaveGestureEvent, handler);
        }

        #endregion WaveGesture

        #endregion GestureEvents
